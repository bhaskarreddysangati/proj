...
export class DashboardComponent   {
    ...
    constructor(private cs: UserService, private router: Router) {
        ...
        this.cs.listUsersPage(1, this.perpagenum).subscribe((data) => {
            if (data) {
    ...
    getPage = function (pageNumber) {
        ...
        if (this.currentPageNum != pageNumber) {
            this.cs.listUsersPage(pageNumber, this.perpagenum).subscribe((data) => {
                this.users = <User[]>data;
    ...
    logout() {
        ...
        this.cs.logoutUser().subscribe((data) => {
            if (data) {
